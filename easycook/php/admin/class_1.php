            ...
            <nav aria-label="페이지네이션" class="padding50">
              <ul class="pagination justify-content-center">
                <?php //페이지네이션이 들어가는 곳
                  //이전페이지
                  if($page <= 1){ ?> 
                    <li class="page-item"><a href="class_1.php?page=1" class="page-link" title="이전페이지로"><i class="bi bi-chevron-left"></i></i></a></li>
                  <?php } else{ ?> 
                    <li class="page-item"><a href="class_1.php?page=<?php echo ($page-1); ?>" class="page-link " title="이전페이지로"><i class="bi bi-chevron-left"></i></i></a></li>
                  <?php }; ?> 
                <?php //여기서부터 페이지 번호출력하기
                  for($print_page=$s_pageNum;$print_page<=$e_pageNum;$print_page++){?>
                    <li class="page-item"><a href="class_1.php?page=<?php echo $print_page; ?>" class="page-link" title="해당페이지로">
                      <?php echo $print_page ?>
                    </a></li>
                  <?php }; ?>  
                  ...
                  <?php if($page>=$total_page){ ?>
                    <li class="page-item"><a href="class_1.php?page=<?php echo $total_page; ?>" title="다음페이지로" class="page-link"><i class="bi bi-chevron-right"></i></i></a></li>
                  <?php }else{ ?>
                    <li class="page-item"><a href="class_1.php?page=<?php echo ($page+1); ?>" title="다음페이지로" class="page-link"><i class="bi bi-chevron-right"></i></a></li>
                <?php };    ?>
              </ul>
            </nav>   
